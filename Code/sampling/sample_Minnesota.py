...
from Methods.utils.priors import Minnesota_Prior,  export_samples

np.random.seed(1)

tails_external_sides=[500,500]
number_of_paths=2000
starting_dates = ["12/2014", "12/2016", "12/2018", "12/2020", "12/2022"]
factors_from = "PCA"
prior_name= "Minnesota_prior"
...
for number_of_lags in number_of_lags_list:
    for frequency in frequencies:
        ...
        prior = Minnesota_Prior(dim=components[frequency], number_of_lags=number_of_lags, lambda_1=lambda_1, lambda_2=lambda_2, lambda_3=lambda_3)
