...
from Methods.utils.priors import Conjugate_Normal_inv_Wishart, vectorize_matrix,  export_samples, make_positive_semidefinite

tails_external_sides=[500,500]
number_of_paths=2000
starting_dates = ["12/2010", "12/2012", "12/2014", "12/2016", "12/2018", "12/2020", "12/2022"]
factors_from = "FSA"
prior_name= "Conj_Norm_Inv_Wish_Prior"
number_of_lags_list=[3]
...
for number_of_lags in number_of_lags_list:
    for frequency in frequencies:
        ...
        beta_0 = vectorize_matrix(B).reshape([K*dim,1]).astype(float)

        Psi_0 = np.diag(np.ones(dim))

        prior = Conjugate_Normal_inv_Wishart(beta_0=beta_0, Psi_0 = Psi_0, S_0 = S_0, nu_0 = K)
...
for starting_date in starting_dates:
    ...
    for number_of_lags in number_of_lags_list:
        ...
        for frequency in frequencies[0:2]:
